        ...
        <div className="homepage">
            ...
            <div className="posts">
                {recentPosts.map((post, index) => (
                    <Post key={index} id={post.id} title={post.title} contents={post.contents} likes={post.likes} className="post" pos={[post.coordinate.latitude, post.coordinate.longitude]} />
                ))}
            </div>
        </div>
    );
